...
async function buscarInstrutor(event) {
  ...
  try {
    ...
    // Atualiza os textos acima dos resultados
    document.getElementById("filtro-info").innerText =
      `Instrutores disponíveis em ${cidade}/${estado}:`;

    document.getElementById("filtro-aplicado").innerText =
      `Filtro aplicado: Categoria ${categoria}, Sexo ${sexo}`;

    // Monta os cards dentro do container
    let cardsHtml = `<div class="carousel-container">`;
      ...
      cardsHtml += `
        <div class="card-instrutor">
          ...
          <div class="conteudo">
            ...
            <p class="categorias">Categoria(s): ${instrutor.categorias || "Não informado"}</p>
    ...
    cardsHtml += `</div>`;
    document.getElementById("resultado").innerHTML = cardsHtml;

  } catch (error) {
    console.error("Erro ao buscar instrutores:", error);
    document.getElementById("resultado").innerHTML =
      "<p>Erro ao buscar instrutores.</p>";
  }
}
